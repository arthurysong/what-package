...
I could easily have improved the performance by moving away from the free tier Heroku deployment. --zzz, I should definitely spend some more money on the projects I work on, if I want any sort of a decent 
...
* Elixir GenServers, Registry
* AWS ECS to run my Elixir nodes (IDK why I went with ECS, adding more crap to learn on top of RabbitMQ)
* Docker (once again, probably should've just went with EC2 instances to keep this project simple)
...
Here's the Elixir Server repo:
Here's the code for the chat client.
